"""Connect to the Rigol MHO954 over LAN and run a basic identity check."""
...
from instruments.registry import OscilloscopeId, connection_for


def main() -> None:
    scope = RigolMHO954(connection_for(OscilloscopeId.MHO954))
    scope.connect()
    try:
        visa = scope.visa
